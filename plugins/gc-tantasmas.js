...
m.reply(`*[ ⚠ الناس ال مبتتفاعلش خالص ⚠ ]*\n\n*الجروب:* ${await conn.getName(m.chat)}\n*الاعضاء:* ${sum}\n\n*[ 👻 قائمة الأشباح 👻 ]*\n${sider.map(v => '  ❈↲ تفاعل يحب ✨💜 @' + v.replace(/@.+/, '')).join('\n')}\n\n*ملحوظة : مش شرط ان البوت يكون صح 100% غير انه بيعت الرسايل وهو شغال بس او وقت ما دخل الجروب + الاشباح هنا المقصود بيهم ال دخلو الجروب ومتفاعلوش خالص*`, null, { mentions: sider })}
