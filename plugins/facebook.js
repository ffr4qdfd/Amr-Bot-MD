...
if (!args[0]) throw `*ارجو ان تعطيني رابط الفيديو المطلوب عشان يتم تنزيله📖؛!!! 
مثال:  ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/` 
if (!args[0].match(/www.facebook.com|fb.watch/g)) throw `*ارجو ان تعطيني رابط الفيديو المطلوب عشان يتم تنزيله📖؛!!! 
مثال:  ${usedPrefix + command}* https://fb.watch/fOTpgn6UFQ/`
try {
m.reply(`*ارجو منك ان تنتظر بعض دقايق عشان بدورلك على الفيديو المطلوب! 😐📖*`)    
...
await conn.sendFile(m.chat, url3, 'error.mp4', '*هذا هو الفيديو الخاص بك', m)         
} catch (err5) {
console.log('5 ' + err5)    
try {
...
handler.command = /^(فيسبوك|facebook2|fb2|facebookdl2|fbdl2|facebook3|فيس|facebookdl3|fbdl3|fb4|facebookdl4|fbdl4|facebook5|fb5|facebookdl5|fbdl5)$/i
